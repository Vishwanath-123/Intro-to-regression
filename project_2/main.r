...
# load data
df <- read.csv("/home/pluton/Documents/Desktop Files/sem-6/Intro to regression/presentation_2/Country_data2.csv")
...
setwd("/home/pluton/Documents/Desktop Files/sem-6/Intro to regression/presentation_2")
# saving the fig in the current working directory
